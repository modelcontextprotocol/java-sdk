 ...
 *
 * <p>
 * The session operates asynchronously using Project Reactor's {@link Publisher} type for
...
public interface McpSession {
	 ...
	 */
	default Publisher<Void> sendNotification(String method) {
	 ...
	 * @return a Mono that completes when the notification has been sent
	 */
	Publisher<Void> sendNotification(String method, Object params);

	/**
	 * Closes the session and releases any associated resources asynchronously.
	 * @return a {@link Publisher<Void>} that completes when the session has been closed.
	 */
