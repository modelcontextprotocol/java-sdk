...
> **Tip:** The core `io.modelcontextprotocol.sdk:mcp` module provides STDIO, Streamable-HTTP and SSE client transport implementations without requiring external web frameworks.
>
...
> **Tip:** This [quickstart demo](https://modelcontextprotocol.io/quickstart/client), based on Spring AI MCP, will show you how to build an AI client that connects to MCP servers.
...
WebClient-based client transport. Requires the `mcp-spring-webflux` dependency.
...
Check the [Server Completion capabilities](server.html#completion-specification) to learn how to enable and configure completions on the server side.
