...
public interface McpServer {
	...
	class AsyncSpecification {
		...
		public AsyncSpecification tool(McpSchema.Tool tool,
				BiFunction<McpAsyncServerExchange, McpServerFeatures.RequestWithContext<McpSchema.CallToolRequest>, Mono<CallToolResult>> handler) {
	...
	class SyncSpecification {
		...
		public SyncSpecification tool(McpSchema.Tool tool,
				BiFunction<McpSyncServerExchange, McpServerFeatures.RequestWithContext<McpSchema.CallToolRequest>, McpSchema.CallToolResult> handler) {
			Assert.notNull(tool, "Tool must not be null");
			Assert.notNull(handler, "Handler must not be null");
