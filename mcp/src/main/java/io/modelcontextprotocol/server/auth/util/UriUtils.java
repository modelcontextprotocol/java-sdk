package io.modelcontextprotocol.server.auth.util;
...
public class UriUtils {
	...
	public static String constructRedirectUri(String redirectUriBase, Map<String, String> params) {
		try {
			...
			if (!params.isEmpty()) {
				String newParams = params.entrySet()
					.stream()
			...
			return new URI(uri.getScheme(), uri.getAuthority(), uri.getPath(), queryBuilder.toString(),
					uri.getFragment())
				.toString();
		}
