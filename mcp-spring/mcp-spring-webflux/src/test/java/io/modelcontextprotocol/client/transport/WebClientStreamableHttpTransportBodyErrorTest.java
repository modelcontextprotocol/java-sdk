 ...
 */
@Timeout(15)
public class WebClientStreamableHttpTransportBodyErrorTest {
	...
	@Test
	void bodyErrorOnSseStreamEmitsSyntheticErrorResponse() throws InterruptedException {
		...
		assertThat(errorResponse.id()).isEqualTo("req-123");
