...
```
target/client-spring-http-client-2.0.0-RC1.jar
```
...
npx @modelcontextprotocol/conformance@0.1.15 client \
  ...
  --command "java -jar conformance-tests/client-spring-http-client/target/client-spring-http-client-2.0.0-RC1.jar" \
  --suite auth
```
...
java -jar conformance-tests/client-spring-http-client/target/client-spring-http-client-2.0.0-RC1.jar http://localhost:3000/mcp
```
